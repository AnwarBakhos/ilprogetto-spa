  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1.5 mb-7">
        {[...Array(5)].map((_, i) => (
          <svg key={i} width="15" height="15" viewBox="0 0 24 24" fill="var(--sand)" aria-hidden="true">
      ...
      {/* Review text */}
      <p className="text-[15px] leading-[1.75] mb-8 flex-grow" style={{ color: 'var(--ink)', fontFamily: 'var(--sans)' }}>
        "{review.text}"
      </p>

      {/* Author info */}
      <div className={showButtons ? 'mt-auto pt-6 mb-6' : 'mt-auto pt-6'}>
        <p className="text-[14px] font-[500] mb-1" style={{ color: 'var(--ink)', fontFamily: 'var(--sans)' }}>
          {review.name}
        </p>
        <p className="text-[13px]" style={{ color: 'var(--sand)', fontFamily: 'var(--sans)' }}>
          {review.location}
        </p>
      </div>
