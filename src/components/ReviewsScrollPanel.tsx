...
export function ReviewsScrollPanel({
  ...
  // Check scroll on container change
  useEffect(() => {
  ...
  return (
    <>
      <div
        ...
        style={{ background: darkBg ? 'var(--ink)' : 'var(--cream)' }}
      >
      <div className="max-w-7xl mx-auto">
        ...
        {!compact && (
          <div className="mb-16">
            <div className="flex items-center gap-3 mb-5">
              <div
                className="w-8 h-px"
                style={{ background: darkBg ? 'var(--sand-light)' : 'var(--sand)' }}
                aria-hidden="true"
              />
              <p
                className="text-[11px] tracking-[0.22em] uppercase"
                style={{
                  color: darkBg ? 'var(--sand-light)' : 'var(--sand)',
                  fontFamily: 'var(--sans)',
                }}
              >
                Customer Stories
            ...
            <h2
              ...
              style={{
                ...
                color: darkBg ? 'var(--cream)' : 'var(--ink)',
                marginBottom: '16px',
              }}
            >
              What Our Clients{' '}
              <em
                className="italic"
                style={{ color: darkBg ? 'var(--sand-light)' : 'var(--sand)' }}
              >
                Say
              </em>
            </h2>
            <p
              ...
              style={{
                color: darkBg ? 'rgba(251,251,249,0.7)' : 'var(--mid)',
                fontFamily: 'var(--sans)',
              }}
            >
        ...
        <div className="relative group">
          ...
          {showControls && canScrollLeft && (
            <button
              ...
              style={{
                color: darkBg ? 'rgba(251,251,249,0.6)' : 'var(--sand)',
              }}
            >
              <svg
                width="28"
        ...
        {showControls && (
          <p
            className="mt-20 text-center text-[12px] tracking-[0.1em]"
            style={{
              color: darkBg ? 'rgba(251,251,249,0.5)' : 'var(--sand-light)',
              fontFamily: 'var(--sans)',
            }}
          >
