...
export function generateICS(booking: BookingFormData, bookingId: string): string {
  ...
  const lines = [
    ...
    foldLine(`DESCRIPTION:Your free in-home consultation with iL Progetto LLC is confirmed for ${booking.date} at ${booking.time}. Our team will arrive at ${booking.address}. Questions? Call (858) 338-1678 or email info@ilprogettollc.com. Booking ID: ${bookingId}`),
    'ORGANIZER;CN=iL Progetto LLC:MAILTO:info@ilprogettollc.com',
