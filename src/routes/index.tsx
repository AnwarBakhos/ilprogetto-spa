...
const VIDEO_SCHEMA = {
  ...
  'itemListElement': [
    ...
    { '@type': 'ListItem', 'position': 6, 'item': { '@type': 'VideoObject', 'name': 'Sheer Shade', 'description': 'Floating fabric vanes between sheer facings. Filtered light, sculpted depth.', 'thumbnailUrl': `${SITE_URL}/images/products/Sheer Shades.jpg`, 'contentUrl': `${SITE_URL}/videos/products/Shangri-La S.mp4`, 'uploadDate': '2024-01-01' } },
