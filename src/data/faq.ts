...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  // ─── Pricing ─────────────────────────────────────────────────────────────
  {
    ...
    answer:
      'Custom window treatment pricing in San Diego ranges widely based on product type, size, and quantity. roller shades run $150-$400 per window installed; plantation shutters $250-$600 per window; motorized shades $300-$700 per window; Roman shades $200-$500 per window. We provide an exact quote at your free in-home consultation.',
  },
  {
    id: 'faq-pricing-2', category: 'pricing',
    question: 'Do you offer financing for window treatments?',
    answer: 'Yes. We partner with Synchrony Financial to offer flexible payment plans. Ask about financing at your consultation or call (858) 338-1678.',
  },
  {
  ...
  {
    id: 'faq-pricing-4', category: 'pricing',
    question: "Are your prices competitive with Home Depot or IKEA blinds?",
    answer: "Custom treatments are measured to fit precisely. Big-box blinds come in standard sizes that rarely fit San Diego windows, leaving light gaps. Over 10-20 years, the long-term cost is often comparable or lower with custom.",
  },
  {
